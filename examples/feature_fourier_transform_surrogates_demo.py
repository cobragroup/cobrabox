...
print("=" * 60)
feat = cb.FourierTransformSurrogates(n_surrogates=5, random_state=42)
...
feat_single = cb.FourierTransformSurrogates(n_surrogates=1, random_state=42, return_data=False)
...
feat_multi = cb.FourierTransformSurrogates(
...
feat_ind = cb.FourierTransformSurrogates(
...
try:
    cb.FourierTransformSurrogates(n_surrogates=-1)

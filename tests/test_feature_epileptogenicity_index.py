...
def test_ei_no_discharge_channel_near_zero() -> None:
...
def test_ei_flat_signal_all_zero() -> None:
...
def test_ei_three_channels_ordering() -> None:
...
def test_ei_window_duration_accepted_and_shape_unchanged() -> None:
